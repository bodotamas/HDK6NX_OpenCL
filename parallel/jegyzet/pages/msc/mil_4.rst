...
A legegyszerűbb MPI programnak is tartalmaznia kell az ``MPI_Init`` és ``MPI_Finalize`` hívásokat, így például az alábbi formában képzelhető el (``hello.c``):

.. literalinclude:: mpi_samples/hello.c
   :language: c
...
.. literalinclude:: mpi_samples/master_slave.c
   :language: c
...
.. literalinclude:: mpi_samples/send_message.c
   :language: c
...
.. literalinclude:: mpi_samples/guess.c
   :language: c
...
.. literalinclude:: mpi_samples/guess_reduced.c
   :language: c

.. warning::

    Az ``MPI_Reduce`` függvény esetében figyelni kell a függvény paramétereinek az inicializálása!
...
.. literalinclude:: mpi_samples/guess_red.c
   :language: c
